...
var actorChars = {
  ...
  "^": Fireball, // fireball
  "$": PowerUpON, //Slows gravity on
  "%": PowerUpOFF, //Slows gravity off
  "=": Lava, "|": Lava, "v": Lava  
};
...
PowerUpON.prototype.type = "powerupon";
...
Level.prototype.obstacleAt = function(pos, size) {
  ...
  for (var y = yStart; y < yEnd; y++) {
    for (var x = xStart; x < xEnd; x++) {
      ...
      if (fieldType && fieldType!= "smoke" && fieldType!="volcanoWall") return fieldType;
    }
  }
};
...
PowerUpON.prototype.act = function(step) {
};
...
PowerUpOFF.prototype.act = function(step) {
};
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  } else if (type == "powerupon") {
	  this.status = "powerupon";
	  gravity = 4;
	  jumpSpeed = 5;
  } else if (type == "powerupoff") {
	  this.status = "powerupoff";
	  gravity = 20;
	  jumpSpeed = 10;
  } 
};
...
var arrowCodes = {65: "left", 87: "up", 68: "right", 83: "down"};
